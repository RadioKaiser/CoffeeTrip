...
const Hero = ({ onOrderClick }) => {
  ...
  return (
    <section id="hero" ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=1920')] bg-cover bg-center" />
      </motion.div>
      ...
      >
        ...
        <motion.button
          ...
          className="bg-gold text-white px-12 py-4 rounded-full text-lg font-medium hover:bg-terracotta transition-all duration-300 shadow-2xl hover:shadow-gold/50"
