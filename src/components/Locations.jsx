  ...
  >
    ...
    <address className="space-y-3 text-beige-medium not-italic">
      <div className="flex items-start">
        <LocationIcon className="w-5 h-5 mr-3 mt-1 text-gold flex-shrink-0" />
        <span>{location.address}</span>
      </div>
      <div className="flex items-start">
        <ClockIcon className="w-5 h-5 mr-3 mt-1 text-gold flex-shrink-0" />
        <span>{location.hours}</span>
      </div>
      <div className="flex items-start">
        <PhoneIcon className="w-5 h-5 mr-3 mt-1 text-gold flex-shrink-0" />
        <a 
